...
> **当前正式执行指南已迁移到 `docs/witness-vad-build-ablation-guide-2026-09-02.md`。本文只保留 v9 的 B0--E1 历史过程与审计记录，不再作为 v10 搭建入口。**
> B0--E1 是 CVA-VAD v9 已完成的正式记录，保留用于审计；v9 已 no-go，**禁止进入原 E2**。后续 v10 只按新指南执行。
>
