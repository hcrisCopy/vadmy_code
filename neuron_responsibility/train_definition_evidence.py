...
def main() -> None:
    ...
    for epoch in range(start_epoch, args.max_epoch):
        ...
        running = {key: 0.0 for key in ("total", "original", "binary_rank", "semantic_hard_negative", "normal_suppression", "dnp_rank", "anchor")}
        ...
        for step, (normal, abnormal) in enumerate(progress, 1):
            ...
            loss = (original + args.binary_weight * extra["binary_rank"] + args.semantic_weight * extra["semantic_hard_negative"]
            ...
            values = {"total": loss, "original": original, **extra, "anchor": anchor}
