...
For the main-paper view, a coarser colour-block heatmap now presents all three detector families rather than omitting the diverse expert. It groups the 768 coordinates into 32 consecutive 24-dimension blocks and reports the percentage of each layer's selected neurons inside each block. Primary sparse (32/layer), diverse sparse (64/layer), and directional normality (32/layer) appear as three separated 12-layer bands for both datasets. The exact coordinate heatmap remains a supplementary diagnostic.
