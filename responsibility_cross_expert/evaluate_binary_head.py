#!/usr/bin/env python3
"""Independently re-evaluate a saved head-only checkpoint."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Official UCF AUC / XD AP evaluation.")
    ...
    metrics = official_frame_metrics(
        ...
        device,
        score_cache=output_dir / "score_cache",
    )
    report = {
