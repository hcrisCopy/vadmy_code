...
from universal_neuron_adapter.covariance_expert import (
    covariance_evidence,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Export deterministic covariance-whitened CLS-neuron evidence."
    )
    ...
    for row in tqdm(
        ...
        total=len(frame),
        desc="export covariance neuron evidence",
    ):
