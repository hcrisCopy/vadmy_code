...
class WitnessExpert(nn.Module):
    ...
    def forward(
        ...
        # Absolute normality is meaningful for deciding whether the whole video
        # resembles training-normal data.  Event localization is a different
        # question: it must use within-video deviations so that a video's base
        # activation level cannot masquerade as a temporal event.
